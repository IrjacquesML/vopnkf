...
@endphp
<span class="vop-icon vop-icon-{{ $name }} {{ $class }}" @if($style) style="{{ $style }}" @endif aria-hidden="true">
@switch($name)
    @case('cross')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18M7 8h10"/></svg>
        @break
    @case('bible')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><path d="M12 7v6M9.5 10h5"/></svg>
        @break
    @case('prayer')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22c-1.5-2-4-4.5-4-8a4 4 0 0 1 8 0c0 3.5-2.5 6-4 8z"/><path d="M9 10V6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v4"/><path d="M8 14h8"/></svg>
        @break
    @case('dove')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8c0-2.5-1.5-4-4-4S8 5.5 8 8c0 4 4 6 4 10"/><path d="M12 8c3 0 6 1 8 3l-2 1"/><path d="M8 11c-2 .5-4 2-5 4"/><circle cx="14.5" cy="6.5" r=".8" fill="currentColor"/></svg>
        @break
    @case('light')
        ...
        @break
    @case('heart')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 0 0 0-7.78z"/></svg>
        @break
    @case('users')
    ...
    @case('lock')
        ...
        @break
    @case('unlock')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg>
        @break
    @case('history')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"/><path d="M12 7v5l3 2"/></svg>
        @break
    @case('user')
    ...
    @case('chart')
        ...
        @break
    @case('trophy')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M8 21h8M12 17v4M7 4h10v5a5 5 0 0 1-10 0V4z"/><path d="M5 9H4a2 2 0 0 1-2-2V5a1 1 0 0 1 1-1h2M19 9h1a2 2 0 0 0 2-2V5a1 1 0 0 0-1-1h-2"/></svg>
        @break
    @case('certificate')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="6"/><path d="M8.21 13.89 7 22l5-3 5 3-1.21-8.11"/></svg>
        @break
    @case('settings')
